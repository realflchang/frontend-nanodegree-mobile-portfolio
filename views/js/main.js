...
var resizePizzas = function(size) {
  ...
  // Code was using document.querySelector. I replaced these with document.getElementById
  ...
  function changePizzaSizes(size) {
    ...
    var newwidth = sizeSwitcher(size) * windowwidth; // this line replaces determineDx() function the below FOR loop was calling before.
    var pizzaContainerArray = document.getElementsByClassName("randomPizzaContainer");

    for (var i = 0; i < pizzaContainerArray.length; i++) {
      pizzaContainerArray[i].style.width = newwidth + "px";
    }
  }
...
// Reference to sliding pizzas. Moved to here because we only need to refer to them once,
// we do not need to call it everytime page is scrolled. Was inside updatePositions() function.
